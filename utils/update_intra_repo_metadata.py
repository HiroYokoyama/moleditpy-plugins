...
def update_single_json(json_path: Path) -> tuple[int, int, list[str]]:
    ...
    return updated_sha, updated_ver, missing
...
def main() -> int:
    ...
    for json_path in targets:
        updated_sha, updated_ver, missing = update_single_json(json_path)
