...
Usage (run from repo root or anywhere):
  python api-checker/check_api.py                                    # all plugins, strict
  python api-checker/check_api.py --registry                         # visible plugins only
  python api-checker/check_api.py --registry --default-allowlist     # suppress manager false positives
  python api-checker/check_api.py --registry --default-allowlist --mw-allowlist  # also suppress mw.X compat bridges
  python api-checker/check_api.py --plugin plugins/Atom_Colorizer/atom_colorizer.py
  python api-checker/check_api.py --check-context --show-api
...
# ---------------------------------------------------------------------------
_SCRIPT_DIR  = Path(__file__).resolve().parent          # .../moleditpy-plugins/api-checker/
