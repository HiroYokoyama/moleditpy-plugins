PLUGIN_NAME = "Synthesis Info Report"
PLUGIN_VERSION = "2025.01.21"
PLUGIN_AUTHOR = "HiroYokoyama"
PLUGIN_DESCRIPTION = "Generate a synthesis report with properties, adducts, and structure. Useful for organic synthesis experiments."
PLUGIN_ID = "synthesis_info_report"
...
class ReportDialog(QDialog):
    def __init__(self, mol, parent=None):
        ...
        self.mol = mol
        self.setWindowTitle("Synthesis Info Report")
        self.resize(700, 800)
        self.fetched_data = {}
        self.setup_ui()
    ...
    def build_html(self, pubchem_data, for_pdf=False, img_b64=None, img_w=0, img_h=0):
        ...
        <body>
            ...
            <div style="margin-top: 50px; border-top: 1px solid #ddd; padding-top: 10px; text-align: right; color: gray; font-size: 0.8em;">
                Generated by MoleditPy Synthesis Info Report Plugin (Version {PLUGIN_VERSION})
            </div>
        </body>
        </html>
        """
...
def initialize(context):
    ...
    context.add_analysis_tool("Synthesis Info Report", lambda: show_report(context))
