...
class MopacSetupDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        self.chk_nosym.setToolTip(
            "Recommended for slightly distorted molecules to prevent errors."
        )
    ...
    def generate_content(self):
        ...
        if self.mol:
            ...
            for i in range(self.mol.GetNumAtoms()):
                ...
                lines.append(
                    f"{symbol: <3} {pos.x: >10.5f} {opt_flag} {pos.y: >10.5f} {opt_flag} {pos.z: >10.5f} {opt_flag}"
                )
    ...
    def save_file(self):
        ...
        path, _ = QFileDialog.getSaveFileName(
            self, "Save MOPAC Input", default_name, "MOPAC Input (*.mop *.dat *.txt)"
        )
        if path:
            try:
