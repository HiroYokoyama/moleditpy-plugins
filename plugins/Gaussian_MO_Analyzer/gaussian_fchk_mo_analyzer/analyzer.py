...
class CubeWriter:
    ...
    def write(filepath, atoms, atom_nos, origin, vectors, data, comment=""):
        ...
        # Imported at call time, not module scope: __init__ imports this
        # module before it defines PLUGIN_VERSION, so a top-level import
        # would be circular.
        try:
        ...
        with open(filepath, "w") as f:
            ...
            # shells, and nothing in the numbers says which version wrote it.
            f.write(f"Generated by MoleditPy {PLUGIN_NAME} v{PLUGIN_VERSION}\n")
            f.write(
