"""
Headless GUI tests for NWChem and PySCF input generator dialogs.

Both dialogs follow the same pattern as MOPAC/GAMESS/Psi4:
...
Run locally:
    QT_QPA_PLATFORM=offscreen pytest tests_gui/test_gui_qchem_extras.py -v
"""
